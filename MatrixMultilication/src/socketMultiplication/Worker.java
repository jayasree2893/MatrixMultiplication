...
public class Worker implements Runnable {
	...
	void configurate(String coorIP, int coorPort) {
		try {
			...
			if (nodeYNum % 2 == 0) { // Even # worker connecting manner
	...
	/*	String[] machines = { "137.30.123.203", "137.30.123.204", "137.30.123.205", "137.30.123.206", "137.30.123.207",
				"137.30.123.208", "137.30.123.209", "137.30.123.210", "137.30.123.211", "137.30.123.212",
				"137.30.123.213", "137.30.123.214", "137.30.123.215", "137.30.123.216", "137.30.123.217",
				"137.30.123.218", "127.0.0.1" };*/
		/*
		for (int i=0;i<17;i++){
		...
		/*if (args[4] == machines[0]) {
			String localip = InetAddress.getByName(args[4]).getHostAddress();
			System.out.println(localip);
			Worker worker = new Worker(workerXID, workerYID, 16000, 16500, args[2], Integer.parseInt(args[3]), localip);
			worker.run();
		}
		if (args[4] == machines[0]) {
			String localip = InetAddress.getByName(ip).getHostAddress();
			System.out.println(localip);
			Worker worker = new Worker(workerXID, workerYID, 16001, 16501, args[2], Integer.parseInt(args[3]), localip);
			worker.run();
		}
		if (args[4] == machines[0]) {
			// String localip = InetAddress.getByName(ip).getHostAddress();
			System.out.println(localip);
			Worker worker = new Worker(workerXID, workerYID, 16002, 16502, args[2], Integer.parseInt(args[3]), localip);
			worker.run();
		}
		if (args[4] == machines[0]) {
			// String localip = InetAddress.getByName(ip).getHostAddress();
			System.out.println(localip);
			Worker worker = new Worker(workerXID, workerYID, 16003, 16503, args[2], Integer.parseInt(args[3]), localip);
			worker.run();
		}
		if (args[4] == machines[0]) {
			// String localip = InetAddress.getByName(ip).getHostAddress();
			System.out.println(localip);
			Worker worker = new Worker(workerXID, workerYID, 16004, 16504, args[2], Integer.parseInt(args[3]), localip);
			worker.run();
		}
		if (args[4] == machines[0]) {
			// String localip = InetAddress.getByName(ip).getHostAddress();
			System.out.println(localip);
			Worker worker = new Worker(workerXID, workerYID, 16005, 16505, args[2], Integer.parseInt(args[3]), localip);
			worker.run();
		}
		if (args[4] == machines[0]) {
			// String localip = InetAddress.getByName(ip).getHostAddress();
			System.out.println(localip);
			Worker worker = new Worker(workerXID, workerYID, 16006, 16506, args[2], Integer.parseInt(args[3]), localip);
			worker.run();
		}
		if (args[4] == machines[0]) {
			// String localip = InetAddress.getByName(ip).getHostAddress();
			System.out.println(localip);
			Worker worker = new Worker(workerXID, workerYID, 16007, 16507, args[2], Integer.parseInt(args[3]), localip);
			worker.run();
		}
		if (args[4] == machines[0]) {
			// String localip = InetAddress.getByName(ip).getHostAddress();
			System.out.println(localip);
			Worker worker = new Worker(workerXID, workerYID, 16008, 16508, args[2], Integer.parseInt(args[3]), localip);
			worker.run();
		}
		if (args[4] == machines[0]) {
			// String localip = InetAddress.getByName(ip).getHostAddress();
			System.out.println(localip);
			Worker worker = new Worker(workerXID, workerYID, 16009, 16509, args[2], Integer.parseInt(args[3]), localip);
			worker.run();
		}
		if (args[4] == machines[0]) {
			// String localip = InetAddress.getByName(ip).getHostAddress();
			System.out.println(localip);
			Worker worker = new Worker(workerXID, workerYID, 16010, 16510, args[2], Integer.parseInt(args[3]), localip);
			worker.run();
		}
		if (args[4] == machines[0]) {
			// String localip = InetAddress.getByName(ip).getHostAddress();
			System.out.println(localip);
			Worker worker = new Worker(workerXID, workerYID, 16011, 16511, args[2], Integer.parseInt(args[3]), localip);
			worker.run();
		}
		if (args[4] == machines[0]) {
			// String localip = InetAddress.getByName(ip).getHostAddress();
			System.out.println(localip);
			Worker worker = new Worker(workerXID, workerYID, 16012, 16512, args[2], Integer.parseInt(args[3]), localip);
			worker.run();
		}
		if (args[4] == machines[0]) {
			// String localip = InetAddress.getByName(ip).getHostAddress();
			System.out.println(localip);
			Worker worker = new Worker(workerXID, workerYID, 16013, 16513, args[2], Integer.parseInt(args[3]), localip);
			worker.run();
		}
		if (args[4] == machines[0]) {
			// String localip = InetAddress.getByName(ip).getHostAddress();
			System.out.println(localip);
			Worker worker = new Worker(workerXID, workerYID, 16014, 16514, args[2], Integer.parseInt(args[3]), localip);
			worker.run();
		}
		if (args[4] == machines[0]) {
			// String localip = InetAddress.getByName(ip).getHostAddress();
			System.out.println(localip);
			Worker worker = new Worker(workerXID, workerYID, 16015, 16515, args[2], Integer.parseInt(args[3]), localip);
			worker.run();
		}
		if (args[4] == machines[17]) {
			// String localip = InetAddress.getLocalHost().getHostAddress();
			BufferedReader reader = new BufferedReader(new InputStreamReader(System.in));
			System.out.println(args[4]);
			System.out.println("Enter Worker X port:");
			String xport = reader.readLine();
			System.out.println("Enter Worker's Y port:");
			String yport = reader.readLine();
			Worker worker = new Worker(workerXID, workerYID, Integer.parseInt(xport), Integer.parseInt(yport), args[2],
					Integer.parseInt(args[3]), localip);
			worker.run();
		}*/
